                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="p-8 flex items-center justify-between">
                                ...
                                <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-white transition-all group-hover:bg-[#0E9F6E] group-hover:text-[#0F0F1A]">
